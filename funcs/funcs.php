<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'golfcars.000webhostapp.com'; //Modificar
		$mail->Port = 21; //Modificar
		
		$mail->Username = 'alfredo.ruiz.itt2@gmail.com'; //Modificar
		$mail->Password = '21083946Ea'; //Modificar
		
		$mail->setFrom('alfredo.ruiz.itt2@gmail.com', 'Facultad'); //Modificar
